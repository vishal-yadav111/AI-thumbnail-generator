    ...
    return (
        <>
            ...
            >
                ...
                <img src="/logo.svg" alt="Logo" className="] w-auto h-8 mr-2" />
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                  <Link to="/" className="hover:text-pink-500 transition">Home</Link>
                    ...
                    <Link onClick={() => setIsOpen(false)} to="/my-generations" className="hover:text-pink-500 transition">my generations</Link>
                    <Link  onClick={() => setIsOpen(false)}to="/contact" className="hover:text-pink-500 transition">Contact</Link> 
                    <Link onClick={() => setIsOpen(false)} to="/login" >Contact</Link> 
