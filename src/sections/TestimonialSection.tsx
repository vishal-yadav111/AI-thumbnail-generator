...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Testimonials" text2="Loved by MAny creators Accross World " text3="See how our AI thumbnails maker are helping channels explode their views." />
