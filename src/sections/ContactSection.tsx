...
export default function ContactSection() {
    return (
        <div className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Grow your channel And Increase reach On Channal" text3="Have questions about our Thumbnail Maker, Ready to scale your views? Let's talk." />
