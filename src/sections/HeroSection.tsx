        ...
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <p className="flex items-center gap-1">
                    <span>Generte  Your First Thumbnail For Free</span>
            ...
            >
                Ai Thumbnail Genetrator For Free{" "}
            ...
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop Wasting Your Time On Design ,just create Your Thumbanail From Ai .</motion.p>
            ...
            >
                ...
                <button onClick={()=>Navigate("/")} className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50 transition rounded-full px-6 h-11">
