...
export default function FeaturesSection() {
    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why Use Our Generator" text3="Create Stunning." />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <button onClick={()=>navigate("Generate")} className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
